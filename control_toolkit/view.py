...
* Date: Aug 18th, 2022
* 描述：本文件实现了摄像头捕获图片的JPEG压缩解压缩时间统计和统计图的绘制
'''
...
img_folder ="./bmp2jpeg/frames-jpeg"  #需要识别图片的文件夹
imlist = os.listdir(img_folder)
imlist.sort()
img_compress_folder ="./bmp2jpeg/b"  #需要识别图片的文件夹
...
path = "./bmp2jpeg/img/graph_"+ str(num)+".png"
plt.savefig(path)
